...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'ocean': '0 4px 6px -1px var(--shadow-blue), 0 2px 4px -1px var(--shadow)',
        'ocean-lg': '0 20px 25px -5px var(--shadow-blue), 0 10px 10px -5px var(--shadow)',
        'blue-glow': '0 0 20px var(--primary-accent), 0 0 40px var(--primary-light)',
