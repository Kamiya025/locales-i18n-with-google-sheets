          ...
          <div className="lg:col-span-9 flex flex-col gap-6" style={{ animation: 'fadeUp 0.6s 0.1s cubic-bezier(0.16, 1, 0.3, 1) both' }}>
            ...
            <div className="space-y-4">
              {activeTab === "recent" ? (
                ...
                <div className="space-y-4">
                  <div className="p-3 rounded-xl bg-blue-50/80 border border-blue-100 text-blue-700 text-xs font-semibold leading-relaxed flex items-center gap-3">
                    ...
                    Nếu không thấy file mới, vui lòng đăng xuất và đăng nhập lại để làm mới quyền truy cập Drive.
                  </div>
                  <ProjectDiscovery />
                </div>
              )}
