...
export function RowItemViewer(
  ...
  return (
    <div className="group relative pt-4 sm:pt-4" style={{ animation: 'fadeUp 0.6s cubic-bezier(0.16, 1, 0.3, 1) both' }}>
      {/* Key Token Badge */}
      <div 
      ...
      >
        <span className="opacity-60">KEY:</span> <span className="max-w-[120px] sm:max-w-none truncate">{row.key}</span>
        <svg className="w-2.5 h-2.5 sm:w-3 sm:h-3 opacity-40" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>
      </div>
